    ...
    return (
        <div className="max-w-4xl mx-auto p-4">
            {blogs && blogs.map((blog, index) => (
                <div key={index} className="flex align-items-center border border-gray-300 bg-white shadow-md rounded-xl p-4 w-full md:w-3/4 lg:w-2/3 mx-auto mt-5">
                    <div>
                    ...
                    <div>
                        <button onClick={(()=> handleDelete(blog.id))} className='cursor-pointer'>🗑️</button>
                    </div>
                </div>
            ))}
        </div>
